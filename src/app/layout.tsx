...
export const metadata: Metadata = {
  title: "RedBlack Agency - Marketing That Drives Results",
  description: "Premier marketing agency specializing in data-driven strategies, brand development, and digital campaigns that accelerate business growth.",
  keywords: "marketing agency, digital marketing, brand development, marketing strategy, ROI marketing, business growth",
  metadataBase: new URL("https://redblackagency.com"),
  alternates: {
    canonical: "https://redblackagency.com"
  },
  openGraph: {
    title: "RedBlack Agency - Marketing That Drives Results",
    description: "Premier marketing agency specializing in data-driven strategies that accelerate business growth",
    siteName: "RedBlack Agency",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1763140465673-p1ptzyxw.jpg",
      alt: "RedBlack Agency - Marketing Excellence"
    }]
  },
  twitter: {
    ...
    title: "RedBlack Agency - Marketing That Drives Results",
    description: "Premier marketing agency specializing in data-driven strategies that accelerate business growth",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1763140465673-p1ptzyxw.jpg"]
  },
  robots: {
    index: true,
    follow: true
